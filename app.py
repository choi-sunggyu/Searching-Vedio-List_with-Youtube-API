...
api_key = "AIzaSyAMEXV1De4ukYQBWn_qArKBSVTV5U3eavE"

with open('app.py', 'r', encoding='utf-8') as file:
    content = file.read()

content = content.replace('AIzaSyAMEXV1De4ukYQBWn_qArKBSVTV5U3eavE', api_key)
...
YOUTUBE_API_KEY = "AIzaSyAMEXV1De4ukYQBWn_qArKBSVTV5U3eavE"
